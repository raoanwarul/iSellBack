...
-- Cashify-aligned base prices (mint condition max value, INR)
-- Reference: https://www.cashify.in/sell-old-apple-laptops  (Oct 2025 rates)
-- =====================================================
...
('MacBook', 'MacBook Air M1 (2020)', 32000, 5000, 8000, 3000, 5000, 4000, 2000, 1000),
('MacBook', 'MacBook Air M2 (2022)', 48000, 5000, 10000, 4000, 6000, 5000, 2500, 1500),
('MacBook', 'MacBook Air M3 (2024)', 68000, 5000, 12000, 5000, 7000, 6000, 3000, 2000),
('MacBook', 'MacBook Pro 13" M1 (2020)', 40000, 5000, 10000, 4000, 6000, 5000, 2500, 1500),
('MacBook', 'MacBook Pro 13" M2 (2022)', 55000, 5000, 12000, 5000, 7000, 6000, 3000, 2000),
('MacBook', 'MacBook Pro 14" M1 Pro (2021)', 78000, 5000, 15000, 6000, 8000, 7000, 3500, 2500),
('MacBook', 'MacBook Pro 14" M2 Pro (2023)', 95000, 5000, 18000, 7000, 9000, 8000, 4000, 3000),
('MacBook', 'MacBook Pro 14" M3 (2023)', 85000, 5000, 15000, 6000, 8000, 7000, 3500, 2500),
('MacBook', 'MacBook Pro 14" M3 Pro (2023)', 110000, 5000, 18000, 7000, 9000, 8000, 4000, 3000),
('MacBook', 'MacBook Pro 14" M3 Max (2023)', 140000, 5000, 22000, 9000, 11000, 10000, 5000, 4000),
('MacBook', 'MacBook Pro 16" M1 Pro (2021)', 92000, 5000, 18000, 7000, 9000, 8000, 4000, 3000),
('MacBook', 'MacBook Pro 16" M2 Pro (2023)', 115000, 5000, 20000, 8000, 10000, 9000, 4500, 3500),
('MacBook', 'MacBook Pro 16" M3 Pro (2023)', 125000, 5000, 20000, 8000, 10000, 9000, 4500, 3500),
('MacBook', 'MacBook Pro 16" M3 Max (2023)', 160000, 5000, 25000, 10000, 12000, 11000, 5500, 4500);
...
INSERT INTO public.price_engine (device_type, model_name, base_price, scrap_value, deduction_screen_issue, deduction_body_issue, deduction_battery_issue, deduction_keyboard_issue, deduction_no_charger, deduction_no_box) VALUES
('iPad', 'iPad 9th Gen (2021)', 13500, 3000, 4000, 1500, 2000, 0, 1000, 500),
('iPad', 'iPad 10th Gen (2022)', 21000, 4000, 5000, 2000, 2500, 0, 1500, 800),
('iPad', 'iPad Air 4th Gen (2020)', 24000, 4000, 6000, 2500, 3000, 0, 1500, 1000),
('iPad', 'iPad Air 5th Gen M1 (2022)', 33000, 5000, 7000, 3000, 3500, 0, 2000, 1200),
('iPad', 'iPad Air 6th Gen M2 (2024)', 42000, 5000, 8000, 3500, 4000, 0, 2500, 1500),
('iPad', 'iPad Mini 6th Gen (2021)', 26000, 4000, 6000, 2500, 3000, 0, 1500, 1000),
('iPad', 'iPad Pro 11" M1 (2021)', 40000, 5000, 8000, 3500, 4000, 0, 2500, 1500),
('iPad', 'iPad Pro 11" M2 (2022)', 48000, 5000, 9000, 4000, 4500, 0, 3000, 1800),
('iPad', 'iPad Pro 11" M4 (2024)', 62000, 5000, 11000, 4500, 5000, 0, 3500, 2000),
('iPad', 'iPad Pro 12.9" M1 (2021)', 52000, 5000, 10000, 4500, 5000, 0, 3000, 2000),
('iPad', 'iPad Pro 12.9" M2 (2022)', 65000, 6000, 12000, 5000, 5500, 0, 3500, 2500),
('iPad', 'iPad Pro 13" M4 (2024)', 78000, 6000, 14000, 6000, 6000, 0, 4000, 3000);


-- =====================================================
-- PART 14: SEED DATA - DEVICE PRICES (Storage Variants)
-- Cashify-aligned storage-variant base prices
-- =====================================================

INSERT INTO public.device_prices (device_type, model, storage, base_price) VALUES
-- MacBook
('MacBook', 'MacBook Air M1', '256GB', 35000),
('MacBook', 'MacBook Air M1', '512GB', 42000),
('MacBook', 'MacBook Air M2', '256GB', 48000),
('MacBook', 'MacBook Air M2', '512GB', 55000),
('MacBook', 'MacBook Air M3', '256GB', 65000),
('MacBook', 'MacBook Air M3', '512GB', 72000),
('MacBook', 'MacBook Air M3', '1TB', 82000),
('MacBook', 'MacBook Pro 13" M1', '256GB', 42000),
('MacBook', 'MacBook Pro 13" M1', '512GB', 50000),
('MacBook', 'MacBook Pro 13" M2', '256GB', 55000),
('MacBook', 'MacBook Pro 13" M2', '512GB', 62000),
('MacBook', 'MacBook Pro 14" M1 Pro', '512GB', 78000),
('MacBook', 'MacBook Pro 14" M1 Pro', '1TB', 88000),
('MacBook', 'MacBook Pro 14" M2 Pro', '512GB', 95000),
('MacBook', 'MacBook Pro 14" M2 Pro', '1TB', 108000),
('MacBook', 'MacBook Pro 14" M3', '512GB', 88000),
('MacBook', 'MacBook Pro 14" M3', '1TB', 100000),
('MacBook', 'MacBook Pro 14" M3 Pro', '512GB', 110000),
('MacBook', 'MacBook Pro 14" M3 Pro', '1TB', 122000),
('MacBook', 'MacBook Pro 14" M3 Max', '1TB', 150000),
('MacBook', 'MacBook Pro 14" M3 Max', '2TB', 170000),
('MacBook', 'MacBook Pro 16" M1 Pro', '512GB', 95000),
('MacBook', 'MacBook Pro 16" M1 Pro', '1TB', 108000),
('MacBook', 'MacBook Pro 16" M2 Pro', '512GB', 125000),
('MacBook', 'MacBook Pro 16" M2 Pro', '1TB', 138000),
('MacBook', 'MacBook Pro 16" M3 Pro', '512GB', 140000),
('MacBook', 'MacBook Pro 16" M3 Pro', '1TB', 152000),
('MacBook', 'MacBook Pro 16" M3 Max', '1TB', 170000),
('MacBook', 'MacBook Pro 16" M3 Max', '2TB', 195000),
-- iPad
('iPad', 'iPad 9th Gen', '64GB', 12000),
('iPad', 'iPad 9th Gen', '256GB', 15000),
('iPad', 'iPad 10th Gen', '64GB', 18000),
('iPad', 'iPad 10th Gen', '256GB', 22000),
('iPad', 'iPad Air M1', '64GB', 30000),
('iPad', 'iPad Air M1', '256GB', 35000),
('iPad', 'iPad Air M2', '128GB', 40000),
('iPad', 'iPad Air M2', '256GB', 46000),
('iPad', 'iPad Air M2', '512GB', 54000),
('iPad', 'iPad Air M2', '1TB', 62000),
('iPad', 'iPad Mini 6', '64GB', 26000),
('iPad', 'iPad Mini 6', '256GB', 31000),
('iPad', 'iPad Pro 11" M1', '128GB', 38000),
('iPad', 'iPad Pro 11" M1', '256GB', 44000),
('iPad', 'iPad Pro 11" M1', '512GB', 52000),
('iPad', 'iPad Pro 11" M2', '128GB', 45000),
('iPad', 'iPad Pro 11" M2', '256GB', 52000),
('iPad', 'iPad Pro 11" M2', '512GB', 62000),
('iPad', 'iPad Pro 11" M4', '256GB', 58000),
('iPad', 'iPad Pro 11" M4', '512GB', 68000),
('iPad', 'iPad Pro 11" M4', '1TB', 80000),
('iPad', 'iPad Pro 12.9" M1', '128GB', 48000),
('iPad', 'iPad Pro 12.9" M1', '256GB', 55000),
('iPad', 'iPad Pro 12.9" M1', '512GB', 65000),
('iPad', 'iPad Pro 12.9" M2', '128GB', 58000),
('iPad', 'iPad Pro 12.9" M2', '256GB', 66000),
('iPad', 'iPad Pro 12.9" M2', '512GB', 78000),
('iPad', 'iPad Pro 12.9" M2', '1TB', 92000),
('iPad', 'iPad Pro 13" M4', '256GB', 75000),
('iPad', 'iPad Pro 13" M4', '512GB', 88000),
('iPad', 'iPad Pro 13" M4', '1TB', 102000),
('iPad', 'iPad Pro 13" M4', '2TB', 120000);
...
-- ============================================================
-- REPAIR ISSUES (customer-declared known hardware issues)
-- Shown to customer only when user selects isRepairable=No.
-- Each row is a selectable checkbox with a FLAT deduction
-- representing the typical repair cost. Admin-manageable via
-- standard condition_deductions CRUD in the admin panel.
-- ============================================================
('RepairIssues', 'Screen replacement needed',     12000, 'FLAT', 'CRITICAL', 1),
('RepairIssues', 'Battery replacement needed',     3500, 'FLAT', 'MINOR',    2),
('RepairIssues', 'Keyboard repair needed',         4000, 'FLAT', 'MINOR',    3),
('RepairIssues', 'Trackpad repair needed',         3000, 'FLAT', 'MINOR',    4),
('RepairIssues', 'Speaker repair needed',          1500, 'FLAT', 'MINOR',    5),
('RepairIssues', 'Camera repair needed',           2000, 'FLAT', 'MINOR',    6),
('RepairIssues', 'Charging port repair needed',    2500, 'FLAT', 'MINOR',    7),
('RepairIssues', 'WiFi/Bluetooth repair needed',   2500, 'FLAT', 'MINOR',    8),
('RepairIssues', 'Ports (USB-C) repair needed',    2500, 'FLAT', 'MINOR',    9),
('RepairIssues', 'Hinge replacement needed',       3500, 'FLAT', 'MINOR',   10),
('RepairIssues', 'Body dent repair',               1500, 'FLAT', 'MINOR',   11),
('RepairIssues', 'Back panel replacement',         2500, 'FLAT', 'MINOR',   12),
('RepairIssues', 'Liquid damage signs',            6000, 'FLAT', 'CRITICAL',13),
('RepairIssues', 'Touch ID / Face ID not working', 3000, 'FLAT', 'MINOR',   14),
('RepairIssues', 'Microphone repair needed',       1500, 'FLAT', 'MINOR',   15),
('RepairIssues', 'Power button repair',            1500, 'FLAT', 'MINOR',   16),
('RepairIssues', 'Volume button repair',           1000, 'FLAT', 'MINOR',   17);
